...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jcoff7e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jcoff7e.containers.anotherwebservice.com/
...
```
git clone git@github.com:ryzewtf/container-jcoff7e.git
cd container-jcoff7e
```
...
```
docker attach container-jcoff7e
```
